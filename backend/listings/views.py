...
class SearchView(APIView):
    ...
    def post(self, request, format=None):
        ...
        if days_passed == '1 of less':
            days_passed = 1
        elif days_passed == '2 of less':
            days_passed = 2
        elif days_passed == '5 of less':
            days_passed = 5
        elif days_passed == '10 of less':
            days_passed = 10
        elif days_passed == '20 of less':
            days_passed = 20
